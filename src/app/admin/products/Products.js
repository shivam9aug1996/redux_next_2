...
import { updatePageNumber, useDeleteProductMutation, useGetProductsQuery } from '@/redux/features/Product/productSlice';
          ...
          return (
            ...
            >
              <div
                ...
                className={`w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/4 p-4`} style={{minWidth:200}}
              >
                <div className="border border-gray-300 rounded p-4">
                  ...
                  <p className="text-gray-600">
                    ...
                    &#8377;{item?.price?Number.parseFloat(item?.price).toFixed(2):"N/A"}
                  </p>
