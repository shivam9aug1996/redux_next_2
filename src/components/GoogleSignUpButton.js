  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center bg-white-600 text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline border  hover:bg-gray-100"
      >
